...
const AwsRegion = ({region, onSelect}) => (
    <Form inline>
        <DropdownButton className="default" id="aws-region" onSelect={onSelect} title={region}>
...
const ValueRow = ({label, value, s3s, s3ia, onChange, addon}) => (
    <div className="row panel">
        <Label className="col-sm-3 text-left">{label}</Label>
        ...
        <Label className="col-sm-3 text-center">{currencyFormat(s3s)}</Label>
        <Label className="col-sm-3 text-center">{currencyFormat(s3ia)}</Label>
    </div>
);
                ...
                <div className="jumbotron col-sm-10 col-sm-offset-1" style={transparentBg} >
                    ...
                    <div className="panel panel-primary">
                        ...
                        <div className="panel-heading">
                            <div className="row">
                                <Label className="col-sm-3 text-left"> Resource </Label>
                                <Label className="col-sm-3 text-center"> Unit</Label>
                                <Label className="col-sm-3 text-center"> S3 Standard </Label>
                                <Label className="col-sm-3 text-center"> S3 Infrequent Access </Label>
                            </div>
                        </div>
                        ...
                        <div className="panel-footer">
                            <div className="row">
                                <Label className="col-sm-2 text-left h4"> Totals </Label>
                                <Label className="col-sm-4 text-left h4"> Savings: {currencyFormat(savings)}<small> ({savingsPercent}%)</small> </Label>
                                <Label className="col-sm-3 text-center h4">{ currencyFormat(s3Total) }</Label>
                                <Label className="col-sm-3 text-center h4">{ currencyFormat(s3IaTotal)}</Label>
                            </div>
                        </div>
